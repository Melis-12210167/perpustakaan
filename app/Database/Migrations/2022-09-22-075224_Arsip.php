...
class Arsip extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            'nomor' => ['type'=>'varchar', 'contraint'=>25, 'null' =>true],
            'judul' => ['type' =>'varchar', 'constraint'=>255, 'null' =>true],
            'ringkasan' =>  ['type' =>'text', 'null' =>true],
            'tgl' =>  ['type' =>'date', 'null' =>true],
            'kategori_id' => ['type'=>'int', 'contraint'=>10, 'null'=>true, 'unsigned'=>true],
            'pengguna_id' => ['type'=>'int', 'contraint'=>10, 'null'=>true, 'unsigned'=>true],
            'created_at' =>  ['type' =>'datetime', 'null' =>true],
            'updated_at' =>  ['type' =>'datetime', 'null' =>true],
            'deleted-at' =>  ['type' =>'datetime', 'null' =>true],
        ]);
